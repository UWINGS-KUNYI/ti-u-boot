...
/*
 * Configuration header file for Forlinx OK6254-C dev board
 *
 * Copyright (C) 2022 UWINGS TECHNOLOGIES
 *	KunYi Chen <kunyi.chen@gmail.com>
 */

#ifndef __CONFIG_OK6254C_H
#define __CONFIG_OK6254C_H
...
#if defined(CONFIG_TARGET_OK6254C)
...
#define EXTRA_ENV_OK6254C_SETTINGS					\
...
#define EXTRA_ENV_OK6254C_SETTINGS_MMC				\
	"boot=mmc\0"							\
	"mmcdev=1\0"							\
	"bootpart=1:2\0"						\
	"bootdir=/boot\0"						\
...
#define PREPARE_FDT \
	"echo Preparing FDT...; " \
	"if test $board_name = ok6254c; then " \
		"ehco \" Reading DTB for ok6254c...\"; " \
		"setenv dtb_index 0;" \
	"elif test $board_name = am62x_skevm; then " \
...
#define CONFIG_EXTRA_ENV_SETTINGS					\
	...
	DEFAULT_FIT_TI_ARGS						\
	DEFAULT_MMC_TI_ARGS						\
	EXTRA_ENV_OK6254C_SETTINGS					\
	EXTRA_ENV_OK6254C_SETTINGS_MMC					\
	EXTRA_ENV_DFUARGS						\
